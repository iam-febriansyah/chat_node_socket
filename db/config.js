...
const sequelize = new Sequelize(process.env.DATABASE_DB, process.env.USER_DB, process.env.PASSWORD_DB, {
...
db.user_details = require("./tables/user_details")(sequelize, Sequelize, DataTypes);
...
db.users.hasOne(db.user_details, { foreignKey: "user_id", sourceKey: "user_id" });
